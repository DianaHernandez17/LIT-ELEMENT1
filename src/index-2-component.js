...
export class Index2 extends LitElement {
  ...
  static get styles() {
    return [stylesScss, css`
      /* Agregamos estilos específicos para mejorar la apariencia del formulario */
      .modal-content {
        max-width: 300px;
        margin: auto;
        padding: 20px;
        ...
        <div class="pt-2 d-flex justify-content-left">
          ...
          >
            ...
            <ul class="nav nav-pills flex-column mb-auto" style="width: 25rem;">
              <li class="nav-item">
                <a
                  href="#"href="#" @click="${() => renderPage('index')}"
              ...
              <div>
                ...
                <div id="myModal" class="modal">
                  <div class="modal-content">
                    ...
                    <h2>Nuevo Registro de Compañía</h2>
                    <input id="nombre" type="text" placeholder="Nombre de la Compañía" />
                    <input id="equipo" type="text" placeholder="Nombre del Equipo" />
                    <input id="campana" type="text" placeholder="Nombre de la Campaña" />
